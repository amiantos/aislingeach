...
public struct RequestStatusCheck: Codable {
    ...
    public init(finished: Int? = nil, processing: Int? = nil, restarted: Int? = nil, waiting: Int? = nil, done: Bool? = nil, faulted: Bool? = nil, waitTime: Int? = nil, queuePosition: Int? = nil, kudos: Decimal? = nil, isPossible: Bool? = nil) {
