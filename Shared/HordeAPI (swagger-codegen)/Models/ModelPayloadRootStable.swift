...
public struct ModelPayloadRootStable: Codable {
    ...
    public init(samplerName: SamplerName? = nil, cfgScale: Decimal? = nil, denoisingStrength: Decimal? = nil, seed: String? = nil, height: Int? = nil, width: Int? = nil, seedVariation: Int? = nil, postProcessing: [PostProcessing]? = nil, karras: Bool? = nil, tiling: Bool? = nil, hiresFix: Bool? = nil, clipSkip: Int? = nil, controlType: ControlType? = nil, imageIsControl: Bool? = nil, returnControlMap: Bool? = nil, facefixerStrength: Decimal? = nil, loras: [ModelPayloadLorasStable]? = nil) {
