...
public struct RequestStatusStable: Codable {
    ...
    public var generations: [GenerationStable]?
    /** If True, These images have been shared with LAION. */
    public var shared: Bool?

    public init(finished: Int? = nil, processing: Int? = nil, restarted: Int? = nil, waiting: Int? = nil, done: Bool? = nil, faulted: Bool? = nil, waitTime: Int? = nil, queuePosition: Int? = nil, kudos: Decimal? = nil, isPossible: Bool? = nil, generations: [GenerationStable]? = nil, shared: Bool? = nil) {
