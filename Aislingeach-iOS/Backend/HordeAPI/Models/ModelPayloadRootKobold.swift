...
public struct ModelPayloadRootKobold: Codable {
    ...
    public init(n: Int? = nil, frmtadsnsp: Bool? = nil, frmtrmblln: Bool? = nil, frmtrmspch: Bool? = nil, frmttriminc: Bool? = nil, maxContextLength: Int? = nil, maxLength: Int? = nil, repPen: Decimal? = nil, repPenRange: Int? = nil, repPenSlope: Decimal? = nil, singleline: Bool? = nil, temperature: Decimal? = nil, tfs: Decimal? = nil, topA: Decimal? = nil, topK: Int? = nil, topP: Decimal? = nil, typical: Decimal? = nil, samplerOrder: [Int]? = nil) {
        self.n = n
